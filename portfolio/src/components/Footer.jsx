  ...
  return (
    <div>
        <footer className='min-h-[26vh]'>
            <div>
                <ul class="nav-links" className='flex justify-center gap-8 list-none text text- md:text-2xl lg:text-2xl mb-[2rem]'>
            ...
            <p className='text-center text-xs text-zinc-400'>Copyright 2024 Ashutosh Sagar. All Rights Reserved.</p>
        </footer>
    </div>
  )
}

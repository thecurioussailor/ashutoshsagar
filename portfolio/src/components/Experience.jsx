...
function Experience() {
  return (
    <div>
        <section id='experience' className='flex flex-col justify-center gap-[1rem] pt-[1vh] mx-[10rem] box-border h-fit min-h-[100vh]'>
            <p className='text-center text-slate-500'>Explore My</p>
            <h1 className='text-[3rem] text-center'>Experience</h1>
            <div className='flex flex-col justify-center'>
                <div className='flex my-[2rem] gap-[2rem]'>
